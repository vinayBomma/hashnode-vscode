...
var require_objectid = __commonJS({
  "node_modules/bson-objectid/objectid.js"(exports, module2) {
    ...
    var inspect2 = Symbol && Symbol.for && Symbol.for("nodejs.util.inspect.custom") || "inspect";
    ObjectID2.prototype[inspect2] = function() {
...
// src/api/queries.ts
var apiEndpoint = "https://gql.hashnode.com";
var getAuthUser = async (token) => {
...
// src/providers/BlogDataProvider.ts
var import_vscode = require("vscode");
var BlogsDataProvider = class {
...
var BlogPost = class extends import_vscode.TreeItem {
  constructor(noteId, noteTitle) {
    super(noteTitle);
    this.id = noteId;
    this.iconPath = new import_vscode.ThemeIcon("note");
    this.command = {
      title: "Open Post",
...
// src/utilities/globalState.ts
var saveData = (context, key, value) => {
  context.globalState.update(key, value);
};
var readData = (context, key) => {
...
// src/ui/createPostWebView.ts
function createPostWebView(webview, extensionUri, note) {
  const webviewUri = getUri(webview, extensionUri, ["dist", "webview.js"]);
  const styleUri = getUri(webview, extensionUri, ["dist", "style.css"]);
...
function activate(context) {
  ...
  const createBlog = vscode.commands.registerCommand(
    ...
    () => {
      let postID = (0, import_bson_objectid.default)().toHexString();
      const newPost = {
        id: postID,
        title: "New Blog",
        content: {
